...
const keyScreen = document.getElementById('key-screen') as HTMLDivElement;
const winScreen = document.getElementById('win-screen') as HTMLDivElement;
const winScore = document.getElementById('win-score') as HTMLDivElement;
const loseScore = document.getElementById('lose-score') as HTMLDivElement; ;
const loseScreen = document.getElementById('lose-screen') as HTMLDivElement ;
const trapScreen = document.getElementById('trap-screen') as HTMLDivElement ;
const nextLevel = document.getElementById('next-level-screen') as HTMLDivElement ;
